...
def _register(app):
    ...
    def training_template():
        ...
        ws.append(['21700011', 'BCM/EHS/001/B01', 'Fire Safety Training', '2026-06-10', '2026-06-10', 4, 'Training Hall', 3.5, 4.2])
        ws.append(['21101568', '', 'MS Office Basics', '2026-07-05', '2026-07-06', 8, 'Computer Lab', '', 4.0])
